...
public class Form_Presentacion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("BIENVENIDO AL SISTEMA DE VENTAS");

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel6.setText("LIONS");
        ...
        btnIngresar.setFont(new java.awt.Font("Segoe UI", 1, 28)); // NOI18N
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/datos-del-usuario.png"))); // NOI18N
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        ...
        try
        {
            boolean inicioExitoso = cn.VerificarUsuario(u);
            if (inicioExitoso)
            {
        ...
        {
            JOptionPane.showMessageDialog(null, "Error al verificar el usuario: " + e.toString());
        }
